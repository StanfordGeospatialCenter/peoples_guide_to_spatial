...
Together, these two ideas are the foundation of everything in this book. They’re why I think **spatial data is for everyone**, not just city planners, government agencies, or PhD cartographers.
...
* Understand and work with spatial data formats like GeoJSON, shapefiles, and raster imagery
* Use open source tools like **QGIS**, **PostGIS**, **Leaflet**, and **GeoPandas** to analyze and visualize spatial data
* Build web maps and interactive dashboards that don’t require an account or a corporate login
...
So whether you’re mapping the spread of disease, the location of food banks, or the economic wake of the Eras Tour, this guide is for you.
